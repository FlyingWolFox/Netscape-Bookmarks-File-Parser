...
long_description = 'This is a Parser for the Netscape Bookmarks file format, ' \
                   'generated by browser when exporting bookmarks to html. It ' \
                   'parses the file and deliver you an object representing the ' \
                   'file with the bookmark structure of folders and shortcuts as' \
...
setup(
    ...
    description='Parser for the Netscape Bookmarks file format',
